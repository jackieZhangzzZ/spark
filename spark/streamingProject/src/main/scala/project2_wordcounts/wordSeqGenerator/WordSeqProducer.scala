...
启动与关闭:
   ...
   发送消息: bin/kafka-console-producer.sh --broker-list node4:9092,node4:9093,node4:9094 --topic comments
   消费消息:
     bin/kafka-console-consumer.sh --bootstrap-server node4:9092,node4:9093,node4:9094  --topic   comments  --from-beginning
 */
object WordSeqProducer extends App {
  val events = 10 //生成评论条数
  val topic = "comments"   //主题名
  val brokers = "node4:9092,node4:9093,node4:9094"  // kafka brokers
